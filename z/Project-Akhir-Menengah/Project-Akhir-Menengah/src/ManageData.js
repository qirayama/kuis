                    ...
                    <Table.Body className="divide-y">
                        {
                            data.map((job, index) => (
                                <Table.Row key={job.id} className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <Table.Cell>{job.company_category}</Table.Cell>
                                    <Table.Cell>{job.description}</Table.Cell>
                                    <Table.Cell>{job.price}</Table.Cell>
                                    <Table.Cell>{job.rating}</Table.Cell>
                                    <Table.Cell>{job.release_year}</Table.Cell>
                                    <Table.Cell>{job.size}</Table.Cell>
                                    <Table.Cell>{job.is_android_app}</Table.Cell>
                                    <Table.Cell>{job.is_ios_app}</Table.Cell>
